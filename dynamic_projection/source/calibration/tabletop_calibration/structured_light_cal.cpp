...
public:
  BinaryCalibratorGenerator (int rows=0, int cols=0,
                             int point_rows=0, int point_cols=0){
    this->rows = rows;
    this->cols = cols;
...
int main(int argc, char **argv){
  ...
  Image<byte> temp = get_image(&camera);
