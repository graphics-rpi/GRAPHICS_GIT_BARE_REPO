...
void      initialize_projector_parms ()
{
    strcpy (camera_type, "Optoma EP727");

    cp.Ncx = 1024;		/* [sel]        */
    cp.Nfx = 1024;		/* [pix]        */
    cp.dx = 0.01368;		/* [mm/sel]     */
    cp.dy = 0.01368;		/* [mm/sel]     */
    cp.dpx = cp.dx * cp.Ncx / cp.Nfx;	/* [mm/pix]     */
    cp.dpy = cp.dy;		/* [mm/pix]     */
    cp.Cx = 1024 / 2;		/* [pix]        */
    cp.Cy = 768 / 2;		/* [pix]        */
...
void      initialize_EOS_50D_parms ()
{
    strcpy (camera_type, "Canon EOS 50D");

    cp.Ncx = 1536;		/* [sel]        */
    cp.Nfx = 1536;		/* [pix]        */
    cp.dx = 0.015345;		/* [mm/sel]     */
    cp.dy = 0.015345;		/* [mm/sel]     */
    cp.dpx = cp.dx * cp.Ncx / cp.Nfx;	/* [mm/pix]     */
    cp.dpy = cp.dy;		/* [mm/pix]     */
    cp.Cx = 1536 / 2;		/* [pix]        */
    cp.Cy = 1024 / 2;		/* [pix]        */
...
// use to fix sx at 1.0 9/8/08/tcy
