...
%%%%%%%%% TITLE
\title{\LaTeX\ Author Guidelines for CVPR Workshop on Computational Cameras and Displays}
...
workshop (including CVPR2013 workshops)
 {\bf Note that
  this is consistent with CVPR2011 but a strengthening from some previous CVPR
...
and you believe that the CVPR12 audience would like to hear about your
