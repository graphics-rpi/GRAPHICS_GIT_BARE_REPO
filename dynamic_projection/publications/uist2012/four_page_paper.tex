...
design exploration.  
%The four part study investigates users'
%intuitions about daylighting,
% CHRIS
%and 
%their interaction
...
%that the work surfaces receive adequate lighting for reading.  
%Yet 
Too
...
%\begin{figure}[t]
%  \centering
%  \includegraphics[width=1.65in]{../gi2012_userstudy/images/photos/josh_jonathan_new_contraption}
%  \includegraphics[width=1.65in]{../gi2012_userstudy/images/photos/available_wall_pieces}\vspace{-0.19in}\\
%\begin{minipage}{1.65in}~{\color{white}{\bf a)}}\end{minipage}
%\begin{minipage}{1.65in}~{\color{white}{\bf b)}}\end{minipage}\vspace{0.05in}\\
%  \includegraphics[width=1.65in]{../gi2012_userstudy/images/photos/sample_model}
%  \includegraphics[width=1.65in]{../gi2012_userstudy/images/photos/sample_rendering}\vspace{-0.19in}\\
...
%user's perception of the output must be evaluated. 
Prevalent themes
...
was provided. 
% The second, third, and fourth tasks of the study were
...
% Once the user has explored the
%room, he is asked to draw an annotated sketch of the room showing poor
%or problematic natural lighting (Figure~\ref{figure:sketches}).  
The
...
study.  
%They were free to walk around the space and explore different
...
needs.  
%In the spirit of a cognitive walkthrough, few constraints were
%placed on the specific edits.  
...
%(Figure~\ref{figure:example_room}) 
%has some very specific lighting issues.
...
%
The users' sketches 
%varied in level of detail and style
%(Figure~\ref{figure:sketches}), 
%but users 
...
%noticeable relation to these conditions.  
Five out of six of the
architects identified a cone shaped area of bright light near the
%window.  
%All of the architects used a 2D {\em plan} view to convey
%their information.  
%However, 
...
%recognized glare being a problem in this area. 
...
%seven used 3D perspective to sketch the room.  
...
%In fact, one user from each category
...
%Two architects and two non-architects
%chose the solstices within a couple days.  
%Others mostly chose dates
%across the seasons.  
...
this concept.  
%In Part 2, many users appreciated the complex
...
times. 
% Participant A5 said ``I learned how the sun's direction
...
% (Figure~\ref{figure:diffusing_renovations}),
...
year.  
%Despite this, it was clear that users need additional
...
%daylighting better than with their intuition alone.  
