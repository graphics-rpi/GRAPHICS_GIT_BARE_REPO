...
public:
  ...
  SUTILAPI static void run( const std::string& title, SimpleScene* scene, contDraw_E continuous_mode = CDNone );
  ...
  SUTILAPI static void setCamera(SimpleScene::InitialCameraData& camera_data);
  ...
  // Make sure you only call this from the callback functions found in SimpleScene:
